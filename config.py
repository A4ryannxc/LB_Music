...
OWNER_ID = int(getenv("OWNER_ID", "5266824799"))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/RANDOMGROUPCHAT69")
SUPPORT_CHAT = getenv("SUPPORT_GROUP", "https://t.me/RANDOMGROUPCHAT69")
